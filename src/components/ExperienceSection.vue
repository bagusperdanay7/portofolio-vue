<template>
  <section class="mt-12" id="experience">
    ...
    <ul class="hidden sm:flex flex-col gap-y-5" id="experienceListExceptMobile">
      <li
    ...
    <ul class="flex sm:hidden flex-col gap-y-5" id="experienceListMobile">
      <li
